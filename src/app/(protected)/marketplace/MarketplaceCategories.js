...
//       <div
//         onClick={() => handleClick(cat)}
//         className="flex flex-col items-center justify-center m-0.5 md:m-1 p-1 md:p-3 bg-white rounded-lg hover:bg-[#12513E] hover:text-white shadow cursor-pointer transition"
//       >
//         {cat.parent_id == null && (
//           <img
